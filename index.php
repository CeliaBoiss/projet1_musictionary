            ...
            <section title="articles" id="containerArticles">
                ...
                <div class="articleBorder" id="themeColor1">
                    ...
                    <article class="articleBlock">
                        ...
                        <a class = "articleLink" href = "blues.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                        <a class = "articleLink" href = "jazz.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                        <a class = "articleLink" href = "rap.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                    </article>
                </div>
                ...
                <div class="articleBorder"  id ="themeColor2">
                    ...
                    <article class="articleBlock">
                        ...
                        <a class = "articleLink" href = "rock.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                        <a class = "articleLink" href = "country.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                        <a class = "articleLink" href = "ska.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                    </article>
                </div>
                ...
                <div class="articleBorder"  id ="themeColor3">
                    ...
                    <article class="articleBlock">
                        ...
                        <a class = "articleLink" href = "RNB.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                        <a class = "articleLink" href = "electro.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                        <a class = "articleLink" href = "disco.php"><img class="articleImg" src="https://via.placeholder.com/90" alt=""></a>
                    </article>
                </div>
            </section>
        </main>
